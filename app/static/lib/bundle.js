...
var Landing = function (_Component) {
  ...
  _createClass(Landing, [{
    ...
    key: 'handleAccepts',
    value: function handleAccepts(event) {
    ...
    value: function render() {
      if (this.state.page == 0) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_LoginForm2.default, { first: this.state.firstName, submitHandler: this.handleSubmit, firstNameChange: this.handleFirstName, lastNameChange: this.handleLastName, emailChange: this.handleEmail, acceptChange: this.handleAccepts })
        );
      } else if (this.state.page == 1) {
        return _react2.default.createElement(_QuestionPage2.default, { time: 180.0000001, page: this.state.page, handleNext: this.handleNextQuestion, question: "In your career thus far, what has been your favorite job and least favorite job and why?" });
      } else if (this.state.page == 2) {
        return _react2.default.createElement(_QuestionPage2.default, { time: 180.0000002, page: this.state.page, handleNext: this.handleNextQuestion, question: "What do you hope to be doing professionally five years from now?" });
      } else if (this.state.page == 3) {
        return _react2.default.createElement(_QuestionPage2.default, { time: 180.0000003, page: this.state.page, handleNext: this.handleNextQuestion, question: "Imagine that you are hired to work at a home repair company. Please describe how you would go about generating customers for your new company." });
      } else if (this.state.page == 4) {
        return _react2.default.createElement(_QuestionPage2.default, { time: 180.0000004, page: this.state.page, handleNext: this.handleNextQuestion, question: "Imagine that you work at a home repair company. You recently visited a homeowner and gave them a proposal for $5,000 in repairs to fix a broken outdoor staircase ($1,000), fix a storm drain ($500) and install storm windows for the living room ($3,500). \nYou receive the below email from the client later. Please write your reply below: \nHey! Thanks for coming by earlier. I'm interested in having your home repair company give my house some touch-ups, but I just can't afford the $5,000 right now. I'll be back in touch in six months when I'm done with car payments and can discuss it then. Have a great day! - Doris" });
      } else if (this.state.page == 5) {
        return _react2.default.createElement(_QuestionPage2.default, { time: 180.0000005, page: this.state.page, handleNext: this.handleNextQuestion, question: "What is a CRM?\nWhat are the greatest benefits of using a CRM?" });
      }
    }
  }]);
...
_reactDom2.default.render(_react2.default.createElement(Landing, null), document.getElementById('root'));
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'control' },
            _react2.default.createElement('input', { className: 'input', type: 'text', placeholder: 'First Name', onChange: this.props.handleFirstName })
          )
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'div',
            { className: 'control' },
            _react2.default.createElement('input', { className: 'input', type: 'text', placeholder: 'Last Name', onChange: this.props.handleLastName })
          )
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { className: 'input is-danger', type: 'email', placeholder: 'Email input', onChange: this.props.handleEmail }),
            _react2.default.createElement(
              'span',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'label',
              { className: 'checkbox' },
              _react2.default.createElement('input', { type: 'checkbox', onChange: this.props.handleAccepts }),
...
var _reactCountdownClock = __webpack_require__(29);
  ...
  _createClass(QuestionPage, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'container' },
        _react2.default.createElement(_reactCountdownClock2.default, { seconds: this.props.time,
          color: '#F00',
          alpha: 0.9,
          size: 100,
